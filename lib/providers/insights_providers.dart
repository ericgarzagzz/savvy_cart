...
final monthlyFrequentlyBoughtItemsProvider = FutureProvider<List<FrequentlyBoughtItem>>((ref) async {
  final db = DatabaseHelper.instance;
  return await db.getFrequentlyBoughtItemsLastMonth();
});

final itemPriceHistoryProvider = FutureProvider.family<List<PriceHistoryEntry>, String>((ref, itemName) async {
  final db = DatabaseHelper.instance;
...
final priceSearchResultsProvider = FutureProvider.family<List<Suggestion>, String>((ref, query) async {
  final db = DatabaseHelper.instance;
