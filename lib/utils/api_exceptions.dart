...
class ApiServerException extends ApiException {
  ...
  const ApiServerException(this.statusCode, String message, [dynamic originalError])
      : super(message, originalError);
...
class ApiErrorHandler {
  static void handleHttpError(int statusCode, String responseBody, [dynamic originalError]) {
    switch (statusCode) {
      case 400:
        throw ApiServerException(statusCode, 'Bad request: $responseBody', originalError);
      case 401:
        throw ApiAuthenticationException('Invalid API key or authentication failed', originalError);
      case 403:
        throw ApiAuthenticationException('Access forbidden - check API permissions', originalError);
      case 429:
        throw ApiRateLimitException('API rate limit exceeded. Please try again later.', originalError);
      case 500:
        throw ApiServerException(statusCode, 'Internal server error', originalError);
      case 502:
        throw ApiServerException(statusCode, 'Bad gateway - service temporarily unavailable', originalError);
      case 503:
        throw ApiServerException(statusCode, 'Service unavailable', originalError);
      case 504:
        throw ApiTimeoutException('Gateway timeout', originalError);
      default:
        throw ApiServerException(statusCode, 'HTTP error $statusCode: $responseBody', originalError);
    }
  }
